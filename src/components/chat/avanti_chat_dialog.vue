<!--
  ...
  РАСХОЖДЕНИЕ МАКЕТА: десктопный кадр чата есть — 246:7505, окно 590×662
  по центру кабинета (x=425 в кадре 1440). Реализована боковая панель 420px
  во всю высоту — решение согласовывается с заказчиком отдельно.
