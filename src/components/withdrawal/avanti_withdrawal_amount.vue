<!--
  ...
  Слайдер — общий примитив avanti_range_slider с малым ползунком (22px из
  макета). Подпись над ползунком (слот value) в этом макете не используется:
  сумма стоит в шапке блока.
