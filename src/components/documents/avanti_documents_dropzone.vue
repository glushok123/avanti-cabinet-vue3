<!--
  НЕТ В МАКЕТЕ: зона загрузки файла с перетаскиванием. Отдельного кадра
  в Figma нет, блок собран из токенов панели документов, а его итальянские
  тексты придуманы (см. README, раздел «Расхождения в макете»). Компонент оставлен в коде, но панель включает
  его только пропом `showDropzone`, выключенным по умолчанию, поэтому
  в поставке заказчику зона не показывается.
